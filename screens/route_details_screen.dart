...
class _RouteDetailsScreenState extends State<RouteDetailsScreen> {
  ...
  Future<RouteDetailsData> _loadRouteDetails() async {
    // Fetch the route with geometry and the stops in parallel
    ...
    // Fallback: If the route geometry is empty, create points from the stops
    if (routeWithGeometry.points.isEmpty && stops.isNotEmpty) {
      ...
      if (stopPoints.isNotEmpty) {
        ...
        // Use copyWith on the result to preserve longName etc.
          ...
          return CustomScrollView(
            slivers: [
              SliverAppBar(
                ...
                foregroundColor: contrastingColor, // This ensures back arrow has correct color
                title: Text(
                      ...
                      child: ListTile(
                        ...
                        trailing: (stop.wheelchairBoarding == '1' ||
                            ...
                            ? Icon(
                                ...
                                semanticLabel: (stop.wheelchairBoarding == '2')
