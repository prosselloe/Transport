...
import 'package:transport/models/feed_version.dart';
...
class Agency {
  ...
  // Method to serialize an Agency object to a JSON-compatible map.
  Map<String, dynamic> toJson() {
    return {
      ...
      'agency_url': url,
      // Add other relevant fields that you want to persist.
    };
  }

  // A new constructor to create an Agency instance from the persisted JSON map.
  factory Agency.fromJsonForFavorites(Map<String, dynamic> json) {
    return Agency(
      id: json['onestop_id'] as String,
      name: json['name'] as String,
      agencyName: json['agency_name'] as String?,
      url: json['agency_url'] as String?,
    );
  }
}
